...
GO
PRINT N'Rename refactoring operation with key c3fbbf49-d001-404b-a070-b537f6194d99 is skipped, element [dbo].[CompetitionMatch].[Result] (SqlSimpleColumn) will not be renamed to HomeTeamGoals';


GO
PRINT N'Altering Table [dbo].[CompetitionTeam]...';


GO
ALTER TABLE [dbo].[CompetitionTeam]
    ADD [TotalPoints] INT DEFAULT 0 NOT NULL;


GO
PRINT N'Creating Table [dbo].[CompetitionMatch]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'c3fbbf49-d001-404b-a070-b537f6194d99')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('c3fbbf49-d001-404b-a070-b537f6194d99')
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.CompetitionMatch'))
               AND [type] IN (N'F', N'C')
